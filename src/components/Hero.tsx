      ...
      <div className="mx-auto w-full max-w-[1160px]">
        <div className="grid gap-7 md:grid-cols-[minmax(320px,350px)_minmax(0,1fr)] md:items-start md:gap-12 lg:gap-[86px]">
          ...
          <div className="space-y-4 text-foreground md:pt-0">
            <h1 className="text-[30px] font-normal leading-[1.08] text-foreground md:text-[38px]">
              Danilo Messinese
            </h1>

            <div className="space-y-2 text-[14px] leading-[1.55] md:text-[15px] md:leading-[1.4] md:[text-align:justify]">
              <p>
