...
const CuratedInsights = () => {
  ...
  const insights = [
    ...
    },
    {
      ...
      link: "https://www.nature.com/articles/s42256-025-01109-4",
      color: "text-primary",
      badge: "Research Paper",
      topics: ["AI", "Psychology"],
    },
    ...
    },
    {
      ...
      description: "From poetry to music, AI ingenuity is rivalling that of humans. Should we embrace it, or change the definition of creativity to protect ourselves?",
      abstract:"A Nature feature discussing whether AI outputs qualify as creativity.",
      author: "Matthew Hutson, Nature",
      date: new Date("2025-11-05"),
      link: "https://www.nature.com/articles/d41586-025-03570-y",
      color: "text-primary",
      badge: "Practitioner-oriented article",
      topics: ["AI", "Innovation"],
    },
    {
      ...
      link: "https://pietroortoleva.com/papers/Ortoleva_HTModel.pdf",
      color: "text-primary",
      badge: "Research Paper",
